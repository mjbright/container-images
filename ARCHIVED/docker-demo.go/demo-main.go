...
const (
	...
	image_name_version = "mjbright/docker-demo:alpine6"
	image_version      = "6"
	MAP_ASCII_ART      = "static/img/mapascii.txt"
        LOGO_ASCII_ART     = "static/img/docker_white.txt"
	escape             = "\x1b"
...
func index(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
	    ...
	    if r.URL.Path != "/1" { w.Write([]byte(content)) }
